...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($email_err) && empty($password_err)) {
        ...
        $verification_code = bin2hex(random_bytes(16));
         $verification_link = 'http://localhost/DBMS%20Project/login.php';
        ...
        try {
            ...
            $mail->Password   = 'buyk zfmf rtsa ahah'; // SMTP password
            ...
            $mail->Body    = 'Click the following link to verify your email: <a href="' . $verification_link . '">Verification Link</a>';
            $mail->send();
